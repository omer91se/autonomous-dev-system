...
import { TimestampedCommentForm, TimestampedCommentList } from '@/components/TimestampedComment';
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {feedback.comments && feedback.comments.length > 0 && (
              <div className="card">
                <h3 className="text-lg font-semibold mb-4">Timestamped Feedback</h3>
                <TimestampedCommentList
                  comments={feedback.comments}
                  onCommentClick={(timestamp) => {
                    // This would seek the video to the timestamp
                    // Implementation depends on VideoPlayer API
                  }}
                />
              </div>
            )}
